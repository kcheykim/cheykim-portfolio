...
function About() {
  return (
    <section>
      <h1 id='about' style={{ textAlign: 'left', marginLeft:'10%'}}>About Me</h1>
      <div>
      ...
      <div id='left' style={{float:'right', width:'70%', marginRight:'10%'}}>
        <p>Hi, my name is Kosal Cheykim. I am currently studying Full Stack Development at UC Berkley Extension. 
          ...
          I apply this idea throughout my life so returned to my passion for coding by attending UCB Full Stack Development program.  
          I hope to find a career as a full stack developer and continue to do what I love – coding.</p></div>
      </div>
    </section>
  );
}
